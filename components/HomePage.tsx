...
import { ArrowRight, BookOpen, Users, Beaker, Award, ExternalLink } from 'lucide-react'
...
export default function HomePage({ publications, research }: HomePageProps) {
  const { t } = useI18n()
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-8">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold font-display leading-tight">
                ...
                <span className="text-blue-300">{t.home.heroTitle3}</span>
              </h1>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/20">
                <div>
                  ...
                  <div className="text-sm text-blue-200">{t.home.publications}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold">$13M</div>
                  <div className="text-sm text-blue-200">{t.home.ercFunding}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold">50+</div>
                  <div className="text-sm text-blue-200">{t.home.labMembers}</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="section-title">{t.home.researchAreas}</h2>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12">
            <div>
              <h2 className="section-title">{t.home.featuredPubs}</h2>
              <p className="section-subtitle">
                {t.home.featuredPubsDesc}
              </p>
            </div>
            <Link
              href="/publications"
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="section-title">{t.home.gbmcTitle}</h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">{t.home.ercFundingLabel}</div>
                    <div className="text-sm text-gray-500">{t.home.ercFundingValue}</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">{t.home.collaborativeResearch}</div>
                    <div className="text-sm text-gray-500">{t.home.multiInstitutional}</div>
                  </div>
                </div>
              </div>
              <a
